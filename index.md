...
#### Февраль 2026:
- Уточнены правила раздачи карт, раздача ведущим рекомендована как основной способ. 

#### Декабрь 2024:
Основные отличия от [правил](https://wolvesmafia.wordpress.com/2023/06/05/rules/), по которым играли у Марата:
...
- В Волках есть [Доктор](why-doctor.md) — красный игрок, который может вылечить отстреленного игрока. В классике Доктора нет. 
...
#### 1. Раздача ролей
- Ведущий приветствует игроков и объявляет «В городе ночь». Игроки надевают маски, принимают ночную позу - голова наклонена, руки скрещены на плечах.
- Раздача ролей происходит следующим образом: Ведущий по очереди просит снять маску и открыть глаза каждого из игроков, после чего игрок жестом показывает Ведущему номер карты, которую он хочет открыть. Ведущий отсчитывает нужную карту и показывает игроку (желательно также продублировав роль жестом). Получивший роль игрок снова надевает маску. Выбранную карту менять не разрешается. Допускается также раздача карт [«с подноса»](pre-2026-cards-dealing.html).
